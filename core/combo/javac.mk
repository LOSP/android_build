...
ifeq ($(BUILD_OS), windows)
    COMMON_JAVAC := development/host/windows/prebuilt/javawrap.exe -J-Xmx256m \
        -target 1.7 -Xmaxerrs 9999999
else
    COMMON_JAVAC := javac -J-Xmx512M -target 1.7 -Xmaxerrs 9999999
endif

# Eclipse.
ifeq ($(CUSTOM_JAVA_COMPILER), eclipse)
    COMMON_JAVAC := java -Xmx256m -jar prebuilt/common/ecj/ecj.jar -7 \
...
ifeq ($(CUSTOM_JAVA_COMPILER), openjdk)
    ...
    COMMON_JAVAC := prebuilt/common/openjdk/bin/javac -target 1.7 \
        -Xmaxerrs 9999999
